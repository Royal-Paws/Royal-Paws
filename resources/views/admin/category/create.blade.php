            ...
            <div class="card-body">
                ...
                <form action="{{url('admin/categoria')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            <label>URL</label>
                            <input type="text" name="urlP" class="form-control" placeholder="Ingrese la URL">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="meta_titulo" class="form-control" placeholder="Ingrese el meta-título">
                            @error('meta_titulo') <small class="text-danger">El meta-título es requerido</small>@enderror
                        </div>
                        <div class="col-md-12 mb-3">
                            <label>Palabra Clave</label>
                            <textarea name="palabras_clave" class="form-control" placeholder="Ingrese las palabras clave"></textarea>
                            @error('palabras_clave') <small class="text-danger">Las palabras clave son requeridas</small>@enderror
                        </div>
                        <div class="col-md-12 mb-3">
                            <label>Meta-Descripción</label>
                            <textarea name="meta_descripcion" class="form-control" placeholder="Ingrese la meta-descripción"></textarea>
                            @error('meta_descripcion') <small class="text-danger">La meta-descripción es requerida</small>@enderror
                        </div>
                        
                        <div class="col-md-6 mb-3">
                            <!-- Botón para enviar -->
                            <button type="submit" class="btn btn-primary float-end" style="display: block; width: 150px; max-width: 200px; text-align: center; color: white;">Guardar</button>
                        </div>
                    </div>
                </form>
            </div>
